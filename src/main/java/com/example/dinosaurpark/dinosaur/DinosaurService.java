...
public class DinosaurService {
	private static final List<Dinosaur> DINOSAURS = Arrays.asList(
            ...
            new Dinosaur(3, "스피노사우루스", "Spinosaurus", "백악기", "수각류", "긴 목과 등의 돛 모양의 판", 15.0, 10000.0, 9, 7),
            ...
            new Dinosaur(10, "트리케라톱스", "Triceratops", "백악기", "각룡류", "큰 머리에 세 개의 뿔", 9.0, 7000.0, 8, 7),
            ...
            new Dinosaur(16, "이구아노돈", "Iguanodon", "백악기", "조각류", "이족보행보다 사족보행을 즐겨함", 9.5, 3800.0, 8, 7),

            new Dinosaur(17, "안킬로사우루스", "Ankylosaurus", "백악기", "검룡류 ", "몸통 주위에 방패나 돌출된 판", 6.0, 4000.0, 9, 7),
            new Dinosaur(18, "스테고사우루스", "Stegosaurus", "쥐라기", "검룡류 ", "등에 돌출된 돌기와 돌가죽", 9.0, 2500.0, 7, 8),
