...
public class EmployeeService {
	...
	private static final List<Employee> EMPLOYEES = Arrays.asList(
			...
			// 1
			new Employee(1, "이재일", "리더", "개발팀", "leader@example.com", 123456789, "서울시 강남구", LocalDate.of(1990, 5, 15),
					5),
			...
			new Employee(4, "오지현", "마케터", "개발팀", "jihyun@example.com", 444555666, "서울시 강남구", LocalDate.of(1991, 3, 29),
					4),

			// 팀 2
			new Employee(5, "김무원", "리더", "디자인팀", "moowon@example.com", 777888999, "서울시 강서구", LocalDate.of(1988, 7, 12),
					7),
			...
			// 팀 3
			new Employee(9, "백현준", "리더", "마케팅팀", "hyunjune@example.com", 333444555, "서울시 서초구", LocalDate.of(1987, 4, 3),
					8),
			...
			// 팀 4
			new Employee(13, "김태호", "리더", "영업팀", "taeho@example.com", 444555666, "서울시 송파구", LocalDate.of(1990, 8, 30),
					5),
