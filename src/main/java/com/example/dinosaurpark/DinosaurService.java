...
public class DinosaurService {
	private static final List<Dinosaur> DINOSAURS = Arrays.asList(
			...
			new Dinosaur(3, "렉스마울러", "티라노사우루스", "수각류", "육식", "자신의 영역을 지키기 위해 끊임없이 싸우며, 대형 포식자로서 그 권위를 유지하고 있습니다.", 11.7, 8700.0, 9, 8),
			new Dinosaur(4, "몬스터클로우", "티라노사우루스", "수각류", "육식", "먹이를 사냥하기 위해 활동하는 시간은 특히 빠르며, 강력한 발톱을 통해 상대를 놓치지 않습니다.", 10.4, 8200.0, 9, 5),
